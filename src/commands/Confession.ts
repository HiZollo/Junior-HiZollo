...
export default class Confession extends Command<[GuildMember]> {
  ...
  private confessionRes = {
    hz: [
      ...
      '門都沒有', '我接受你是可能事件，但機率為 0', '謝謝', '出口在左手邊', '你會不會太高估你自己'
    ],
    self: {
      accept: [
        '你也太自戀了吧', '好險你還接受你自己，不然世界上就沒有人看得起你了', '雖然你告白成功，但你的伴侶還是只有左右手',
        '跟這種人告白，就算成功了應該沒什麼意義吧', '你能想像你以後是一個人走入禮堂嗎'
      ],
      reject: ['連自己都拒絕自己，誰還會接受你', '你也知道自己不夠好', '你怎麼連自己做的球都不接，笨蛋大木頭'],
    ...
    other: {
      ...
      goodman: [
        ...
        '恭喜 $fm 被發卡', '$fm 獲得好人卡一張', '$to 認為 $fm 是個再好不過的人了'
      ]
    }
  }
}
